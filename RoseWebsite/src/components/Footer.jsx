    ...
    <footer class="bg-purple-600 py-6 px-10 font-sans tracking-wide">
      <div class="flex items-center justify-between max-sm:flex-col gap-5">
        ...
        <ul class="flex flex-wrap justify-center gap-x-8 gap-4">
          <li>
            <a
              href="https://www.seiu721.org/"
              className="text-xl text-black font-bold hover:text-orange-500"
            >
              SEIU 721
            </a>
          </li>
          <li>
            <a
              href="https://www.linkedin.com/company/seiu-local-721/"
          ...
          <li>
            <a
              href="https://www.instagram.com/rose.seiu/"
              class="text-xl hover:text-gray-400"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="inline w-7 h-7 hover:shadow-lg"
                viewBox="0 0 24 24"
              >
                <linearGradient
                  id="a"
